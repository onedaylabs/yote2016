<div id="fl-branding-form" class="fl-settings-form">
	...
	<form class="fl-settings-form-content" action="<?php FLBuilderAdminSettings::render_form_action( 'branding' ); ?>" method="post">
		...
		<p><?php _e('White label the page builder plugin using the settings below.', 'fl-builder'); ?></p>
		...
		<p><?php _e('White label the page builder theme using the settings below.', 'fl-builder'); ?></p>
		
		<?php $theme_data = FLBuilderModel::get_theme_branding(); ?>
		
		<h4><?php _e('Theme Name', 'fl-builder'); ?></h4>
		<input type="text" name="fl-theme-branding-name" value="<?php echo esc_html( $theme_data['name'] ); ?>" class="regular-text" />
		
		<h4><?php _e('Theme Description', 'fl-builder'); ?></h4>
		<input type="text" name="fl-theme-branding-description" value="<?php echo esc_html( $theme_data['description'] ); ?>" class="regular-text" />
		
		<h4><?php _e('Theme Company Name', 'fl-builder'); ?></h4>
		<input type="text" name="fl-theme-branding-company-name" value="<?php echo esc_html( $theme_data['company_name'] ); ?>" class="regular-text" />
