...
add_action('manage_posts_custom_column', 					   'FLBuilderAdminPosts::render_templates_post_columns_content');
...
add_filter('manage_posts_columns', 							   'FLBuilderAdminPosts::render_templates_post_columns');
