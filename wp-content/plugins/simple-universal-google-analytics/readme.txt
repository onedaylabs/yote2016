...
If you are a non-English speaker please help [translate Simple Universal Google Analytics](https://translate.wordpress.org/projects/wp-plugins/simple-universal-google-analytics) into your language.

== Installation ==

1. Go to the Add New plugins screen in your WordPress Dashboard
1. Click the upload tab
1. Browse for the plugin file (simple-universal-google-analytics.zip) on your computer
