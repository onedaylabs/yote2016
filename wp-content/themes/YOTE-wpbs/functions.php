...
// Thumbnail sizes
add_image_size( 'wpbs-featured', 1280, 190, true );
add_image_size( 'wpbs-featured-home', 1280, 150, true);
add_image_size( 'wpbs-featured-carousel', 1280, 204, true);
...
// ++ Widget for footer full width text
  register_sidebar(array(
        'id' => 'footer_bottom',
        'name' => 'Bottom Footer',
        'before_widget' => '<div id="%1$s" class="widget footer_bottom col-sm-12 %2$s">',
        'after_widget' => '</div>'
  ));

// ++ Widget for homepage slider
     register_sidebar(array(
    	'id' => 'home_slider',
    	'name' => 'home slider',
    	'description' => 'home slider',
    	'before_widget' => '<div id="%1$s" class="widget home_slider %2$s">',
    	'after_widget' => '</div>'
    ));	
...
if( !function_exists("wp_bootstrap_theme_styles") ) {  
    function wp_bootstrap_theme_styles() { 
		...
		// Second stylesheet
        wp_register_style( 'home-styles', get_stylesheet_directory_uri() . '/home.css', array(), '1.0', 'all' );
